<h1> Assignment 3 </h1>
<h2> Molly Cook </h2> 
<h3>File name: bacteria_iteration_final.ipynb</h3>
...
<p>I created a range of cluster numbers and looped through them so that the model would run faster. I found that numbers that were closer together (50,55,60,65...) and a large range (start: 10, end: 700) worked well.</p>
...
<h3>Result</h3>
<p><b>Looking over the final results, the model did pretty well! The biggest issue I had initially was that salmon and fish products were winding up in unrelated clusters. I was finally able to get fish products out of salsa, ice cream, veggies, etc. (I think some of the adjectives like 'fresh' used to describe the fish were pretty similar to adjectives used to describe fruits and vegetables, which inevitably made salmon wind up with romaine.) </b></p>

<p><b>Here is a smoked fish cluster:</b></p>
...
<p><b>Here is a (separate!) salsa cluster:</b></p>
